...
QVariant ODataRequestHandler::handleRequest(QUrl url, QUrlQuery query, QVariant body, QVariantMap head, Method method)
{
    ...
    else
    {
        ...
        ODataURLWalk * urlWalk = new ODataURLWalk(this->model, url, query, body, head, method,this);
